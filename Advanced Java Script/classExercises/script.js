// IF ELSE (daca ... altfel)
// if(conditie) {
//     executaConditieAdevarata
// } else {
//     executaCondititeFalsa
// }
var nume = "Mihai";
if (nume === "SDA") {
    console.log("Hello world SDA!")
} else {
    console.log("Hello world anyone else!")
}

// && - logical AND (folosit pentru a lega conditiile)
// & - bitwise AND (converteste valorile in biti si le compara prin shifting)
// || - logical OR (folosit pentru a lega conditiile)
...
if (rezultat < 50) {
    console.log("rezultat mai mic ca si 50: " + rezultat);
}

console.log("rezultat2: " + myFunction(21, 45));

// void function - nu returneaza nimic
...
myFunctionVoid(43, 2);
var myFunctionVoidResult = myFunctionVoid(1, 3); // myFunctionVoidResult nu va stoca valoarea deoarece functia este void si nu returneaza nimic
...
// parametrii functiei - variabilele pe care le primeste functia in definitie (type, message)
// argumentele functiei - variabilele pe care le primeste functia cand o apelam ("error", 'mesajEroare')
...
// apelarile functiei
logger("error", 'mesajEroare');
logger("warning", 'mesajAtentionare');
logger("hahhahahahah", 'oriceAltceva');

logger("error" + 'mesajEroare' + '1' + '2');
logger("errrormesajEroare12");
...
//a function which converts human years in dog years
...
console.log(`humanToDog2: ${humanToDog(2.5, 'large')}`);
console.log('humanToDog3:', humanToDog(2.5, 'medium'));
...
// strings and numbers cannot be implicitly passed by reference
var obj = {
    name: "pencil",
    price: 10
};
